...
export const prefixClassTerms = 'terms';

export const Terms = () => {
	return (
		<div className={`container`}>
			<div className={`${prefixClassTerms}`}>
				<h1>Terms of Use</h1>
				<p>
				...
				<p>
					<span>
						This website is operated by <strong>[Merchant Name]</strong>. The
						terms “we”, “us”, and “our” refer to{' '}
						<strong>[Merchant Name]</strong>. The use of our website is subject
						to the following terms and conditions of use, as amended from time
						to time (the “Terms”). The Terms are to be read together by you with
						...
						authorized to access our website, use any of our website’s services
				...
				<p>
					<span>
						<strong>
							<span>2. Use of our Website</span>
						</strong>
					</span>
				</p>
				<p>
				...
				<p>
					<span>
						<strong>
							<span>3. General Conditions</span>
						</strong>
					</span>
					<strong>&nbsp;</strong>
				</p>
				...
				<p>
					<span>
						...
						any service, content, feature or product offered through our
						website.
					</span>
				</p>
				<p>
				...
				<p>
					<span>
						<strong>
							<span>4. Products or Services</span>
						</strong>
					</span>
					<strong>&nbsp;</strong>
				</p>
				...
				<p>
					<span>
						<strong>
							<span>5. Links to Third-Party Websites</span>
						</strong>
					</span>
				</p>
				<p>
				...
				<p>
					<span>
						<strong>
							<span>6. Use Comments, Feedback, and Other Submissions</span>
						</strong>
					</span>
				</p>
				<p>
				...
				<p>
					<span>
						<strong>
							<span>7. Your Personal Information</span>
						</strong>
					</span>
				</p>
				<p>
				...
				<p>
					<span>
						<strong>
							<span>8. Errors and Omissions</span>
						</strong>
					</span>
				</p>
				<p>
				...
				<p>
					<span>
						<strong>
							<span>9. Disclaimer and Limitation of Liability</span>
						</strong>
					</span>
				</p>
				<p>
				...
				<p>
					<span>
						<strong>
							<span>13. Headings</span>
						</strong>
					</span>
				</p>
				<p>
					<span>Any headings and titles herein are for convenience only.</span>
				</p>
				<p>
					<strong>
						<br />
				...
				<p>
					...
					<span style={{ fontWeight: 'lighter' }}>
						<strong>[Name of Province] </strong>
					</span>
					<span style={{ fontWeight: 'lighter' }}>
						...
						website must be brought before the courts of the Province of{' '}
					</span>
					<span style={{ fontWeight: 'lighter' }}>
						<strong>[Name of Province] </strong>
					</span>
					<span style={{ fontWeight: 'lighter' }}>in the City of </span>
					<span style={{ fontWeight: 'lighter' }}>
				...
				<p>
					<span>
						<strong>[Name of Province] </strong>and you irrevocably consent to
				...
				<p>
					<span>
						<strong>
							<span>16. Questions or Concerns</span>
						</strong>
					</span>
				</p>
				<p>

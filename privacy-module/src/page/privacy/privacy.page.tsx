...
export const prefixClassPrivacy = 'privacy';

export const Privacy = () => {
	return (
		<div className={`container`}>
			<div className={`${prefixClassPrivacy}`}>
				...
				<p>
					...
					<span style={{ fontWeight: 'lighter' }}>
						...
						for the Protection of Personal Information and Canada's{' '}
					</span>
				...
				<p>
					<span>
						...
						<strong>
							[If applicable, include a description of any parties
						</strong>{' '}
						<strong>with whom you may share Personal Information.]</strong>
					</span>
				</p>
				<p>
					<span>&nbsp;</span>
				...
				<p>
					<span>&nbsp;</span>
					<strong>7. Safeguarding Customer Information</strong>
				</p>
				<p>
					<span>
				...
				<p>
					<strong>10. Handling Customer Complaints and Suggestions</strong>
					<span style={{ fontWeight: 'lighter' }}>&nbsp;</span>
				</p>
				<p>
					<span>
						You may direct any questions or enquiries with respect to our
						privacy policy or our practices by
					</span>
				</p>
				<p>
